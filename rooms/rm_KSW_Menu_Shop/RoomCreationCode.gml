...
#region Discord
scr_Discord_Setup("Shop","Coins - " + string(global.KSW_CurrentCoins),"icon",global.gameTitle,"strimp","From Strimp's Kitchen");
#endregion

#region Entered
global.KSW_EnteredShop = true;
#endregion