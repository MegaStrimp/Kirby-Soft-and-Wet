...
function scr_KSW_SetBobbers()
{
	...
	scr_KSW_AddBobber("yellow","Yellow",spr_KSW_Bobber_Yellow,glimmer,25,0,-4,false);
	scr_KSW_AddBobber("purple","Purple",spr_KSW_Bobber_Purple,flux,25,0,-4,false);
	scr_KSW_AddBobber("redPeg","Red Peg",spr_KSW_Bobber_RedPeg,candy,50,0,-9);
	scr_KSW_AddBobber("anchor","Anchor",spr_KSW_Bobber_Anchor,legion,50,0,0);
	scr_KSW_AddBobber("worm","Wormiller",spr_KSW_Bobber_Wormiller,glimmer,100,0,0);
	scr_KSW_AddBobber("dynamite","Dynamite",spr_KSW_Bobber_Dynamite,glimmer,100,0,0);
	...
	scr_KSW_AddBobber("dedede","Dedede",spr_KSW_Bobber_Dedede,borange,0,0,-9);
	...
	scr_KSW_AddBobber("nightmareOrb","Nightmare Orb",spr_KSW_Bobber_NightmareOrb,mage,0,0,-9);
	scr_KSW_AddBobber("legend","Legend",spr_KSW_Bobber_Legend,flux,0,0,-9,true);
