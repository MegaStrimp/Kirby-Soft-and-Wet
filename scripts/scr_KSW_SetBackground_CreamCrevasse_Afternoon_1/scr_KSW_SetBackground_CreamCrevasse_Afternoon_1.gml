///@description KSW - Set Background - Cream Crevasse - Afternoon - 1

function scr_KSW_SetBackground_CreamCrevasse_Afternoon_1()
{
	if (backgroundSetup)
	{
		...
		backgroundIndex[arrayIndex] = layer_background_create(backgroundLayer[arrayIndex],bg_KSW_CreamCrevasse_Afternoon_1);
		arrayIndex += 1;
