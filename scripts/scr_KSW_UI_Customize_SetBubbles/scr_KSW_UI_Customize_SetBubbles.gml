...
function scr_KSW_UI_Customize_SetBubbles()
{
	...
	if (global.shaders) scr_KSW_UI_Customize_CreateBubble(KSW_UI_Customize_Bubbles.sprayPaints,spr_KSW_UI_Customize_Bubble_SprayPaints_Small,spr_KSW_UI_Customize_Bubble_SprayPaints_Medium,spr_KSW_UI_Customize_Bubble_SprayPaints_Big,spr_KSW_UI_Customize_Text_SprayPaints);
