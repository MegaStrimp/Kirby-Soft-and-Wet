///@description KSW - Set Background - Cream Crevasse - Night - 1

function scr_KSW_SetBackground_CreamCrevasse_Night_1()
{
	if (backgroundSetup)
	{
		...
		backgroundIndex[arrayIndex] = layer_background_create(backgroundLayer[arrayIndex],bg_KSW_CreamCrevasse_Night_1);
		arrayIndex += 1;
		backgroundLayer[arrayIndex] = layer_create(backgroundAnchor - (arrayIndex + 1));
