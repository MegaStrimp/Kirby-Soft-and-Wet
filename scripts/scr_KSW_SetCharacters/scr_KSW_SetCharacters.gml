...
function scr_KSW_SetCharacters()
{
	...
	scr_KSW_AddCharacter("adventureKirby","Adventure Kirby",spr_KSW_UI_Customize_CharacterIcon_AdventureKirby,candy,scr_KSW_Player_AdventureKirby_Setup,300,spr_KSW_UI_Customize_Spray_AdventureKirby);
	#endregion
}