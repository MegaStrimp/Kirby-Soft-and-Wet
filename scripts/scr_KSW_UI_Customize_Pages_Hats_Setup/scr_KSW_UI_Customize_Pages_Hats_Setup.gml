///@description KSW - UI - Customize - Pages - Hats - Setup

function scr_KSW_UI_Customize_Pages_Hats_Setup()
{
	#region Initialize Variables
	#region Selection List
	scr_KSW_Menu_Component_CreateSelectionList(global.KSW_HatCount[global.playerCharacter[playerNum]]);
	#endregion
