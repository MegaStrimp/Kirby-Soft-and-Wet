///@description KSW - UI - Customize - Pages - Spray Paints - Setup

function scr_KSW_UI_Customize_Pages_SprayPaints_Setup()
{
	#region Initialize Variables
	#region Selection List
	scr_KSW_Menu_Component_CreateSelectionList(global.KSW_SprayPaintCount[global.playerCharacter[playerNum]]);
	#endregion
