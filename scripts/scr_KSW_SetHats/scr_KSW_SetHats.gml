...
function scr_KSW_SetHats()
{
	...
	scr_KSW_AddHat(playerID + "_" + "None",playerID,"None",-1,undefined,candy,0,0,0,true);
	...
	scr_KSW_AddHat(playerID + "_" + "StrawHat",playerID,"Straw Hat",-1,undefined,borange,100);
	#endregion
	#endregion
}