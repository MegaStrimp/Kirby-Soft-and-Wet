///@description KSW - Set Background - Cream Crevasse - Night - 2

function scr_KSW_SetBackground_CreamCrevasse_Night_2()
{
	if (backgroundSetup)
	{
		...
		backgroundIndex[arrayIndex] = layer_background_create(backgroundLayer[arrayIndex],bg_KSW_CreamCrevasse_Night_2);
		arrayIndex += 1;
