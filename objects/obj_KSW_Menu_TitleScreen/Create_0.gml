...
scr_KSW_Menu_TitleScreen_CreateBubble(KSW_MainMenu_Buttons.aquarium,spr_KSW_Menu_TitleScreen_Bubble_Fishbook_Small,spr_KSW_Menu_TitleScreen_Bubble_Fishbook_Medium,spr_KSW_Menu_TitleScreen_Bubble_Fishbook_Big,spr_KSW_Menu_TitleScreen_Text_Fishbook);
