...
scr_KSW_Menu_TitleScreen_CreateBubble(KSW_MainMenu_Buttons.aquarium,spr_KSW_Menu_TitleScreen_Bubble_Aquarium_Small,spr_KSW_Menu_TitleScreen_Bubble_Aquarium_Medium,spr_KSW_Menu_TitleScreen_Bubble_Aquarium_Big,spr_KSW_Menu_TitleScreen_Text_Aquarium);
